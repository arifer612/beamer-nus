...
\titlebackground*{images/NUS_default_BG}

\newcommand{\hrefcol}[2]{\textcolor{cyan}{\href{#1}{#2}}}

\title{An Introduction to the NUS Beamer Style}
\subtitle{Using \LaTeX\ to prepare slides}
\author{\href{mailto:arif.er@u.nus.edu}{Arif Er}}
\date{Written on November 1, 2023}

\begin{document}
\maketitle

\begin{frame}{Beamer for NUS slides}
\begin{itemize}
...
\framesubtitle{Selecting the NUS Theme}
To start working with \texttt{nusbeamer}, start a \LaTeX\ document with the
preamble:
\begin{block}{Minimum NUS Beamer Document}
...
\footlinecolor{nusyellow}
\begin{frame}[fragile]{Changing Slide Style}
\begin{itemize}
\item You can select the white or blue \textbf{slide style} \emph{in the
preamble} with \verb|\themecolor{white}| (default) or \verb|\themecolor{blue}|
      \begin{itemize}
...
\verb|\footlinecolor{color}|
      ...
      \testcolor{nusblue}, \testcolor{nusyellow},
      \testcolor{nusgreen}, \testcolor{nusdarkgreen}
      \item Default is no footline; you can restore it with
      \verb|\footlinecolor{}|
      \item Others may work, but no guarantees!
      \item Should \emph{not} be used with the \verb|blue| theme!
      \end{itemize}
\end{itemize}
\end{frame}
...
\begin{colorblock}[black]{nuslightgreen}{Colour Blocks}
...
\small
\begin{verbatim}
\begin{colorblock}[black]{nuslightgreen}{title}
content...
\end{colorblock}
\end{verbatim}
\end{colorblock}
The ``official'' colours of colour blocks are: \testcolor{nuslilla},
\testcolor{nusblue}, \testcolor{nusdarkgreen}, and
\testcolor{nusyellow}.
\end{column}
\end{columns}
\end{frame}
...
\begin{itemize}[<alert@2>]
  ...
  \item The colours are defined in the \texttt{nuscolor} package:
  \begin{itemize}
  \item Primary colours: \testcolor{nusblue} and its sidekick
  \testcolor{nusgrey}
  \item Three shades of green: \testcolor{nuslightgreen},
  \testcolor{nusgreen}, \testcolor{nusdarkgreen}
  \item Additional colours: \testcolor{nusyellow}, \testcolor{nusred},
        \testcolor{nuslilla}
        \begin{itemize}
        \item These may be shaded---see the \verb|nuscolor| documentation or
...
{images/NUS_Logo_color_vertical}
\end{verbatim}
\end{block}
\end{column}
\begin{column}{0.3\textwidth}
...
\begin{chapter}[images/NUS_default_BG]{nusred}{Special Slides}
\begin{itemize}
\item Chapter slides
...
\item There are seven ``official'' colours: \testcolor{nusblue},
\testcolor{nusdarkgreen}, \testcolor{nusgreen},
\testcolor{nuslightgreen}, \testcolor{nusred}, \testcolor{nusyellow},
\testcolor{nuslilla}.
      \begin{itemize}
...
\begin{sidepic}{images/NUS_default_BG}{Side-Picture Slides}
\begin{itemize}
...
\begin{itemize}
\item To insert a final slide with the NUS motto, use
\texttt{$\backslash$backmatter}.
      \begin{itemize}
      \item The motto also appears in footlines
